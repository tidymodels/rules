...
This outlines how to propose a change to rules. For more detailed info
...
Please note that the rules project is released with a [Contributor Code
of Conduct](https://rules.tidymodels.org/dev/CODE_OF_CONDUCT.md). By
